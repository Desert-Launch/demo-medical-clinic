...
export const seedSpecialties: Specialty[] = [
  {
    ...
    description:
      "Family medicine is where most visits to the clinic begin. Our GPs handle everyday illness, long-term conditions like diabetes and hypertension, health screening, and the referrals that send you to the right specialist upstairs rather than across town.",
    treats: [
...
export const seedDoctors: Doctor[] = [
  {
    ...
    bio: "Has run family medicine clinics for fourteen years and set up the clinic's diabetes review programme. Sees a lot of patients who have been passed between departments and want one person holding the thread.",
  ...
  },
  {
    ...
    bio: "Runs the annual health check clinic and the travel vaccination service. The doctor most likely to talk you out of a test you do not need, and into the one you have been avoiding.",
  ...
  },
  {
    ...
    bio: "Covers the walk-in and same-day list, which means most of the day is fevers, chest infections and injuries that are not quite an emergency. Keeps late slots open on weekday evenings.",
  ...
  },
  {
    ...
    bio: "Built the clinic's dermoscopy service and photographs every lesion checked, so next year’s appointment starts from evidence rather than memory.",
    languages: ["Arabic", "English"],
    yearsExperience: 16,
    consultationFeeAED: 350,
  ...
  },
  {
    ...
    bio: "Treats a lot of adult acne and melasma, and is candid about how long each takes to shift. Runs the laser list on Tuesdays and Thursdays.",
  ...
  },
  {
    ...
    bio: "Leads the paediatric wing and holds back morning slots every day for sick children. Has looked after some families here since their first child’s six-week check.",
    languages: ["Arabic", "English"],
    yearsExperience: 12,
    consultationFeeAED: 300,
  ...
  },
  {
    ...
    bio: "Runs the childhood asthma clinic and the allergy testing list. Parents tend to book for the second opinion and stay for the follow-ups.",
  ...
  },
  {
    ...
    bio: "Spent nine years in a tertiary cardiac centre before moving to outpatient work. Reads their own echoes and stress tests, and will tell you on the day whether something needs a hospital.",
    languages: ["Arabic", "English"],
    yearsExperience: 19,
    consultationFeeAED: 500,
  ...
  },
  {
    ...
    bio: "Looks after the blood pressure and cholesterol clinic and the heart failure follow-ups. Appointments run long on purpose — most of the work is in the conversation.",
  ...
  },
  {
    ...
    bio: "Does the nasal endoscopy list and the snoring assessments. Direct about which sinus problems need surgery and which need six weeks of doing the boring thing properly.",
  ...
  },
  {
    ...
    bio: "Runs the hearing clinic and sees most of the children with glue ear and recurrent tonsillitis, jointly with paediatrics when it helps.",
  ...
  },
  {
    ...
    bio: "Leads the physiotherapy team and takes most of the post-operative knee and shoulder work. Every patient leaves the first session with a printed programme and a date to be reassessed.",
    languages: ["Arabic", "English"],
    yearsExperience: 10,
    consultationFeeAED: 380,
...
const patientSeeds: PatientSeed[] = [
  { firstName: "Patient", lastName: "1", age: 34, gender: "female", phone: "+971 52 555 1xxx", insurer: 0, allergies: "Penicillin — rash", notes: "Prefers a female doctor. Arabic first language." },
  { firstName: "Patient", lastName: "2", age: 52, gender: "male", phone: "+971 54 555 2xxx", insurer: 1, notes: "Type 2 diabetes, reviewed quarterly by family medicine." },
  { firstName: "Patient", lastName: "3", age: 41, gender: "female", phone: "+971 55 555 3xxx", insurer: 0 },
  { firstName: "Patient", lastName: "4", age: 63, gender: "male", phone: "+971 56 555 4xxx", insurer: 2, allergies: "Aspirin", notes: "On blood pressure medication. Brings his own readings." },
  { firstName: "Patient", lastName: "5", age: 7, gender: "female", phone: "+971 50 555 5xxx", insurer: 3, allergies: "Peanuts — carries an adrenaline pen", notes: "Mother attends all appointments. Asthma reviewed by paediatrics." },
  { firstName: "Patient", lastName: "6", age: 29, gender: "male", phone: "+971 52 555 6xxx", insurer: null, notes: "Self-paying. Asks for a printed invoice each visit." },
  { firstName: "Patient", lastName: "7", age: 46, gender: "female", phone: "+971 54 555 7xxx", insurer: 4 },
  { firstName: "Patient", lastName: "8", age: 3, gender: "male", phone: "+971 55 555 8xxx", insurer: 3, notes: "Vaccination schedule up to date. Father is the contact." },
  { firstName: "Patient", lastName: "9", age: 58, gender: "female", phone: "+971 56 555 9xxx", insurer: 1, allergies: "Latex" },
  { firstName: "Patient", lastName: "10", age: 37, gender: "male", phone: "+971 50 555 0xxx", insurer: 0 },
  { firstName: "Patient", lastName: "11", age: 25, gender: "female", phone: "+971 52 555 1xxx", insurer: 5, notes: "Acne treatment plan with dermatology, month four." },
  { firstName: "Patient", lastName: "12", age: 44, gender: "male", phone: "+971 54 555 2xxx", insurer: 2, notes: "Lower back rehab after a disc injury." },
  { firstName: "Patient", lastName: "13", age: 33, gender: "female", phone: "+971 55 555 3xxx", insurer: 0 },
  { firstName: "Patient", lastName: "14", age: 61, gender: "male", phone: "+971 56 555 4xxx", insurer: 1, allergies: "Sulfa drugs", notes: "Cardiology follow-up every six months." },
  { firstName: "Patient", lastName: "15", age: 39, gender: "female", phone: "+971 50 555 5xxx", insurer: 4 },
  { firstName: "Patient", lastName: "16", age: 31, gender: "male", phone: "+971 52 555 6xxx", insurer: 3 },
  { firstName: "Patient", lastName: "17", age: 28, gender: "female", phone: "+971 54 555 7xxx", insurer: 3, notes: "Works nights — asks for morning slots only." },
  { firstName: "Patient", lastName: "18", age: 49, gender: "male", phone: "+971 55 555 8xxx", insurer: 2, allergies: "Ibuprofen — stomach upset" },
  { firstName: "Patient", lastName: "19", age: 36, gender: "female", phone: "+971 56 555 9xxx", insurer: 5 },
  { firstName: "Patient", lastName: "20", age: 55, gender: "male", phone: "+971 50 555 0xxx", insurer: 1, notes: "Treadmill test done in March, repeat due next year." },
  { firstName: "Patient", lastName: "21", age: 9, gender: "female", phone: "+971 52 555 1xxx", insurer: 3, allergies: "Dust mites" },
  { firstName: "Patient", lastName: "22", age: 22, gender: "male", phone: "+971 54 555 2xxx", insurer: null, notes: "Self-paying student rate applied." },
  { firstName: "Patient", lastName: "23", age: 43, gender: "female", phone: "+971 55 555 3xxx", insurer: 4, notes: "Interpreter not needed. Prefers evening appointments." },
  { firstName: "Patient", lastName: "24", age: 47, gender: "male", phone: "+971 56 555 4xxx", insurer: 4 },
  { firstName: "Patient", lastName: "25", age: 30, gender: "female", phone: "+971 50 555 5xxx", insurer: 0 },
  { firstName: "Patient", lastName: "26", age: 57, gender: "male", phone: "+971 52 555 6xxx", insurer: 5, allergies: "Shellfish", notes: "Records transferred in from a previous clinic in March." },
  { firstName: "Patient", lastName: "27", age: 38, gender: "female", phone: "+971 54 555 7xxx", insurer: 5 },
  { firstName: "Patient", lastName: "28", age: 45, gender: "male", phone: "+971 55 555 8xxx", insurer: 2, notes: "Runner. Recurrent ankle problems, sees physiotherapy." },
  { firstName: "Patient", lastName: "29", age: 34, gender: "female", phone: "+971 56 555 9xxx", insurer: 1 },
  { firstName: "Patient", lastName: "30", age: 66, gender: "male", phone: "+971 50 555 0xxx", insurer: 2, allergies: "Codeine", notes: "Hard of hearing — face him when speaking." },
];
